...
If the output is clean (STATUS: ok with no flags), respond:
TRIGGER: none
...
/**
 * Extract a learning signal from a guardian's output.
 * Called asynchronously after each guardian run — does not block the watcher.
 */
